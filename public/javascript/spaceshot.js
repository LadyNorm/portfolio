...
(function(){
  ...
  var mainState = {
    preload : function(){
      this.game.load.image('bullet','images/spaceshot/bullet.png');
      this.game.load.image('bgSpace','images/spaceshot/farback.jpg');
      this.game.load.image('bgSpace2','images/spaceshot/starfield.png');
      this.game.load.spritesheet('ship','images/spaceshot/Spritesheet_64x29.png',64,29,4);
      this.game.load.spritesheet("enemyship1","images/spaceshot/eSpritesheet_40x30.png",40, 30, 6);
      this.game.load.spritesheet("enemyship2","images/spaceshot/eSpritesheet_40x30_hue1.png",40, 30, 6);
      this.game.load.spritesheet("enemyship3","images/spaceshot/eSpritesheet_40x30_hue2.png",40, 30, 6);
      this.game.load.spritesheet("enemyship4","images/spaceshot/eSpritesheet_40x30_hue3.png",40, 30, 6);
      this.game.load.spritesheet("enemyship5","images/spaceshot/eSpritesheet_40x30_hue4.png",40, 30, 6);
    },
